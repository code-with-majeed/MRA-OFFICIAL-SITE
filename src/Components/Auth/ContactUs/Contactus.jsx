  ...
  return (
    <div className="w-full flex-1 bg-gray-50 -mt-15">
      ...
      <div className="max-w-7xl mx-auto py-5 px-4 sm:px-6 lg:px-8">
        <div
          className={`text-center mt-12 mb-10 transition-all duration-700 ${
            ...
            <div className="bg-gradient-to-br from-[#1B388E] to-[#051b6b] text-white p-10 lg:p-12 flex flex-col justify-between">
              <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} viewport={{ once: true }}>
                ...
                <ul className="space-y-6 text-sm md:text-base">
                  <motion.li whileHover={{ x: 8 }} className="flex gap-4 items-start group">
                    <motion.div className="w-10 h-10 rounded-full bg-[#1B388E]/30 flex items-center justify-center flex-shrink-0 group-hover:bg-[#1B388E]/60 transition-colors" whileHover={{ scale: 1.2 }}>
              ...
              <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ delay: 0.3 }} className="flex gap-4 mt-10">
                <motion.a
            ...
            <div className="bg-white p-10 lg:p-12">
              <form className="space-y-8">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  type="submit"
                  className="bg-[#1B388E] text-white px-8 py-3.5 rounded-lg hover:bg-[#082375] hover:shadow-xl transition-all duration-300 font-semibold text-sm md:text-base focus:ring-4 focus:ring-[#1B388E]/30 shadow-md cursor-pointernpm "
                >
                  Send Message
                </motion.button>
                </div>
